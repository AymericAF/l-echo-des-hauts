...
const HEBERGEUR = 'HOSTINGER INTERNATIONAL LTD, 61 Lordou Vironos Street, 6023 Larnaca, Chypre';
...
export const MENTIONS_DU_CHAMP = {
  fr: [
    ...
    },
    {
      ...
      obligatoire: true,
      motif: new RegExp(`Site hébergé par ${HEBERGEUR}\\.`),
    },
  ],
  en: [
    {
    ...
    },
    {
      ...
      obligatoire: true,
      motif: new RegExp(`Site hosted by ${HEBERGEUR}\\.`),
    },
  ],
};
