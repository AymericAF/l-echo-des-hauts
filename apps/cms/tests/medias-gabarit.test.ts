 ...
 * quinze fac-similes qui RETOMBERAIT au gabarit — regeneration ratee, revert, ecrasement
...
/**
 * LES ONZE REDESSINES, ET LA LIGNE DE TITRE QUE CHACUN CONSERVE.
 *
 ...
 * sont maintenant tenus par la meme garde que les onze.
 */
...
/** Les quinze fac-similes du corpus, redessines et modeles confondus. */
...
test('les quinze fac-similes DESSINENT leur document — aucun ne retombe au gabarit', () => {
...
test('chacun des onze redessines conserve la ligne de titre a laquelle la legende s adosse', () => {
...
test('les quinze annoncent un DOCUMENT, et le corpus les designe comme la piece qu ils montrent', () => {
